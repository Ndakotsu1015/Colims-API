...
class AwardLetterControllerTest extends TestCase
{
    ...
    {
        $contract_sum = $this->faker->randomFloat(
            /** float_attributes **/
        );
        ...
        $response = $this->post(route('award-letters.store'), [
            ...
            'due_date' => $due_date,
            'award_letter_document_file' => $award_letter_document_file,
        ]);
        ...
        $awardLetters = AwardLetter::query()
            ...
            ->where('award_letter_document_file', $award_letter_document_file)
            ->get();
    ...
    public function update_behaves_as_expected()
    {
        ...
        $this->assertEquals($award_letter_document_file, $awardLetter->award_letter_document_file);
    }
