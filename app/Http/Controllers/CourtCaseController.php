...
class CourtCaseController extends Controller
{
    ...
    {
        $courtCases = CourtCase::with('handler', 'postedBy', 'caseStatus', 'caseOutcome', 'solicitor')->get();
    ...
    public function store(CourtCaseStoreRequest $request)
    {
        ...
        return new CourtCaseResource($courtCase->load('handler', 'postedBy', 'caseStatus', 'caseOutcome', 'solicitor'));
    }
